...
import { 
  ...
  ShieldCheck, Phone, Mail, UserRoundPen
} from "lucide-react";
...
export default function AdminReporters() {
  ...
  const handleToggleStatus = (id: string, currentStatus: string) => {
    ...
    toast({
      ...
      description: `Reporter status changed to ${newStatus}.`,
    });
  };
  ...
  const handleAddUser = async () => {
    ...
    try {
      ...
      toast({ title: "Provisioned", description: `Reporter account provisioned for ${newName}.` });
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold font-headline tracking-tight">రిపోర్టర్ల నిర్వహణ (Reporters)</h1>
      ...
      <div className="relative">
        ...
        <Input 
          placeholder="రిపోర్టర్ పేరు లేదా ఈమెయిల్ ద్వారా వెతకండి..." 
          ...
          <Table>
            <TableHeader className="bg-muted/30">
              <TableRow>
                ...
                <TableHead className="font-bold">కాంటాక్ట్ (ID)</TableHead>
