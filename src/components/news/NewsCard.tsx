    ...
    <div className="news-card-snap w-full max-w-md mx-auto bg-white shadow-xl relative overflow-hidden flex flex-col">
      <div className="relative h-2/5 w-full">
        ...
        <div className="absolute top-4 left-4">
          <div className="bg-primary/90 text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1 shadow-lg">
      ...
      <div className="p-6 flex-1 flex flex-col justify-between">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed text-lg line-clamp-[8]">
            {news.content}
          </p>
        </div>
